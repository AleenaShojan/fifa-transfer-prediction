...
model = load_model(r"C:\Users\irind\OneDrive\Desktop\project\fifa_transfer_value_model.keras")
...
df = pd.read_csv(r"C:\Users\irind\Downloads\DL_Dataset\female_players.csv")  # Ensure this file is correctly referenced
